...
import { FileText, Calendar, Clock, Edit3, Plus, X, Save, Loader2 } from "lucide-react";
...
const RegisterAtestadoCard = memo(function RegisterAtestadoCard({
    atestadoStartDate,
    atestadoDays,
    atestadoDescription,
    editingAtestado,
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 pt-3 border-t border-gray-200">
                        <Button
                            ...
                            className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white transition-colors duration-200 flex items-center justify-center space-x-2 h-9 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isSubmitting ? (
                                <>
...
export default RegisterAtestadoCard;