...
import { StudentDataService } from '../src/services/studentDataService';
import type { Estudante } from '../src/types';
 ...
 */
async function checkV2Exists(estudanteId: string): Promise<boolean> {
 ...
 */
async function checkV3Exists(estudanteId: string): Promise<boolean> {
 ...
 */
async function checkV3Contacts(estudanteId: string): Promise<number> {
 ...
 */
async function cleanup(estudanteId: string): Promise<void> {
 ...
 */
async function test1_CreateStudent(): Promise<boolean> {
  ...
  try {
    ...
    await StudentDataService.addStudent(TEST_STUDENT);
 ...
 */
async function test2_UpdateStudent(): Promise<boolean> {
  console.log('✏️  TESTE 2: Atualizar Estudante (Dual-Write)');
  console.log('━'.repeat(60));

  try {
    // Atualizar estudante
    const updatedStudent: Estudante = {
      ...TEST_STUDENT,
    ...
    await StudentDataService.updateStudent(updatedStudent);
 ...
 */
async function test3_ReadStudent(): Promise<boolean> {
  console.log('📖 TESTE 3: Ler Estudante (V3 com fallback V2)');
  console.log('━'.repeat(60));

  try {
    // Ler estudante
    console.log('Lendo estudante via StudentDataService...');
    const student = await StudentDataService.getStudentById(TEST_STUDENT.estudanteId);
