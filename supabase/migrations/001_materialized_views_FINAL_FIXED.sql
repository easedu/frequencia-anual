-- ============================================================================
-- FASE 2: MATERIALIZED VIEWS - Eliminação de N+1 Queries (VERSÃO CORRIGIDA)
-- ============================================================================
-- Criado em: 2025-10-24
-- Autor: Claude Code
-- Versão: FINAL FIXED (removidos campos inexistentes)
...
-- ❌ Removido: mc.file_url (renomeado para document_url)
-- ❌ Removido: sus.decision_by, decision_date, notification_date (não existem)
-- ❌ Removido: sus.severity (não existe em student_suspensions)
-- ============================================================================
