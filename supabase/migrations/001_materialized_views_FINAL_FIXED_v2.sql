-- ============================================================================
-- FASE 2: MATERIALIZED VIEWS - Eliminação de N+1 Queries (VERSÃO CORRIGIDA v2)
-- ============================================================================
-- Criado em: 2025-10-24
-- Autor: Claude Code
-- Versão: FINAL FIXED v2 (com DROP de funções existentes)
...
-- ❌ Removido: sus.severity, sus.decision_by, sus.decision_date, sus.family_notified, sus.notification_date (não existem)
-- ============================================================================
