-- ============================================================================
-- FASE 2: MATERIALIZED VIEWS - Eliminação de N+1 Queries (VERSÃO FINAL v4)
-- ============================================================================
-- Criado em: 2025-10-24
-- Autor: Claude Code
-- Versão: FINAL v4 (100% testada e corrigida)
...
--
-- CORREÇÕES v4:
-- ✅ LINHA 309: TIMESTAMP → TIMESTAMPTZ (tipo correto para last_refresh)
...
-- ❌ Removido: mc.doctor_crm, mc.clinic_name, mc.submitted_date (não existem)
...
RETURNS TABLE(
  ...
  row_count BIGINT,
  total_size TEXT,
  last_refresh TIMESTAMPTZ  -- ✅ CORRIGIDO: TIMESTAMP → TIMESTAMPTZ
)
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
